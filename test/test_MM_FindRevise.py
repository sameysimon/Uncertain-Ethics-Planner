...
def test_DoubleAction():
    ...
    ssp.VisualiseExplicitGraph(solution=bpsg, fileName='test/graphs/policyDouble')
...
def test_random_medium():    
    ...
    ssp.VisualiseExplicitGraph(solution=bpsg, fileName='test/graphs/randoMediumExplicit')
